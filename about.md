...
<div style="background: linear-gradient(135deg, rgba(33, 150, 243, 0.1) 0%, rgba(156, 39, 176, 0.1) 100%); padding: 40px; border-radius: 12px; margin: 40px 0;">

### 🎯 Expertise Across the Stack
We combine theoretical depth with practical implementation skills, from mathematical foundations to production-ready code.

### 🏆 Track Record of Impact
Our papers appear in top-tier venues (CVPR, ICML, AAAI) and address both fundamental research questions and real-world applications.

### 🤝 Collaborative Approach
We thrive on collaboration, bringing together diverse perspectives to solve challenging problems in generative AI.

### 🚀 Research-to-Application Pipeline
From initial concept to working implementation, we deliver complete solutions with reproducible code and clear documentation.
...
<strong>🎨 Color & Style Transfer</strong>
<p style="margin: 10px 0 0 0; color: #757575; font-size: 0.95em;">Optimal transport, rectified flows, diffusion guidance</p>
</div>

<div style="background: white; padding: 20px; border-radius: 8px; border-left: 4px solid #9C27B0;">
<strong>🤖 Generative Models</strong>
<p style="margin: 10px 0 0 0; color: #757575; font-size: 0.95em;">Diffusion models, GANs, training-free methods</p>
</div>

<div style="background: white; padding: 20px; border-radius: 8px; border-left: 4px solid #2196F3;">
<strong>📐 Theoretical Foundations</strong>
<p style="margin: 10px 0 0 0; color: #757575; font-size: 0.95em;">Latent space geometry, information theory</p>
</div>
...
<p style="text-align: center; color: #757575; font-size: 0.9em; margin-top: 60px;">
